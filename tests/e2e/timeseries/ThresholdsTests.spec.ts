...
test.describe('Thresholds displayed in graph', () => {
  test('should display the thresholds correctly', async ({ page }) => {
    await page.goto('/topology/node/viewer_rivers_level_stations/viewer_rivers_level_stations_forecast/map/waterdepth_sfincs_inland/location/Umgeni_Mouth_level')
    ...
    await page.waitForTimeout(1000); // Wait for the thresholds to load
