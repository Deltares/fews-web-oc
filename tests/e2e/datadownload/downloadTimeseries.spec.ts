...
const cases = [
  {
    name: 'location',
    url: '/viewer_coastal_water_levels/viewer_coastal_water_levels_d3d/map/kzn_waterlevel/location/NSRI_Tide_Gauge_level',
  },
  {
    name: 'coordinates',
    url: '/viewer_meteorology_rainfall_forecast/viewer_meteorology_rainfall_forecast_saws_1x1/map/saws1/coordinates/-29.115/32.083',
  },
  {
    name: 'node id',
    url: '/viewer_coastal_water_levels/viewer_coastal_water_levels_d3d/series',
  },
]

cases.forEach(({ name, url }) => {
  test.describe(`Download Time Series with ${name}`, () => {
