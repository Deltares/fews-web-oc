...
const props = withDefaults(defineProps<Props>(),{
  src: 'https://rwsos-dataservices-ont.avi.deltares.nl/iwp/test/FewsWebServices/ssd?request=GetDisplay&ssd=KGT_GentTerneuzen_ERG',
  fitWidth: true
})
  ...
  onMounted(()=> {
    ...
    if(ssdContainer.value) {
      ...
      ssdContainer.value.addEventListener('wheel', mouseWheelHandler, { passive: true })
    }
