...
function updateSource() {
    ...
    source.updateImage({
        url: `${baseUrl}/wms?service=WMS&request=GetMap&version=1.3&layers=${props.layer.name}&crs=EPSG:3857&bbox=${getMercatorBboxFromBounds(bounds)}&height=${canvas.height}&width=${canvas.width}&time=${time}`,
