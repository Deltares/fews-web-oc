...
export class ParticlePropagator {
  ...
  private bindUniforms(dt: number): void {
    ...
    gl.uniform1f(
      this.program.getUniformLocation('u_u_scale_in'),
      this.velocityImage.uScale
    )
    gl.uniform1f(
      this.program.getUniformLocation('u_u_offset_in'),
      this.velocityImage.uOffset
    )
    gl.uniform1f(
      this.program.getUniformLocation('u_v_scale_in'),
      this.velocityImage.vScale
    )
    gl.uniform1f(
      this.program.getUniformLocation('u_v_offset_in'),
